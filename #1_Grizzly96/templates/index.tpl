          ...
          <div class="catalog__header row">
            ...
            <div class="catalog-filter col-md-8 js-catalog-filter">
              ...
              {section name=q loop=$catalog}
                ...
                <a class="menu__item menu__item--{$step}
                {if $smarty.section.q.first} is-active {/if}"
                href="javascript:void(0);">
                  <svg class="item__icon">
                    <use xlink:href="#grizzly" class="use-default"/>
                  </svg>
                  <div class="item__text">{$catalog[q].category_name}</div>
                </a>
              {/section}
            </div> <!-- /.catalog__menu -->
            ...
            <div class="catalog__grid__item col-xs-6 col-md-4 js-item">
              <div class="item__image">
                <a href="javascript:void(0);">
                  ...
                  <img src="{$catalog[q].items[w].images[0].link_sml}">
                </a>
              </div> <!-- /.item__image -->
              <div class="item__description">
                <div class="description__name">{$catalog[q].items[w].name}</div>
                <div class="description__size">Размер:
                  <span class="size--normal">{$catalog[q].items[w].size}</span>
                </div>
                <div class="description__price">
                  {if $catalog[q].items[w].sale == "yes"}
                  <span class="price--old">{$catalog[q].items[w].price}&nbsp;руб.</span>
                  <span class="price--new">{$catalog[q].items[w].sale_price}&nbsp;руб.</span>
                  {else}
                  <span class="price--normal">{$catalog[q].items[w].price}&nbsp;руб.</span>
                  {/if}
                </div>
              ...
              <div class="hidden item-gallery">
                ...
                <a href="{$catalog[q].items[w].images[e].link_big}"></a>
                {/section}
              </div>
            </div> <!-- /.grid__item -->
          {if !$smarty.section.w.last}{/if}
          {/section}
          </div> <!-- /.catalog-grid -->
          {/section}
